...
export function ProfileDropdown({ darkMode, toggleDarkMode }: { darkMode: boolean, toggleDarkMode: () => void }) {
    ...
    return ( 
      ...
      >
        ...
        >
                <img src={user.imageUrl || "/assets/icons/profile-placeholder.svg"} alt="profile" className="d w-32 h-25 rounded-full border border-1 border-dark-1" />
